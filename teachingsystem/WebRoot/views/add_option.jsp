...
<html>
	...
	<body>
		<div id="bg">
			...
			<div id="page">
			 <div id="dan" style="display: none;">	
				...
				<input type="text" name="answer" id="chooseA"/>
				...
				<input type="text" name="answer" id="chooseB"/><br/>
				<span style="margin-left:20px">选项C：</span>
				<input type="text" name="answer" id="chooseC"/><br/>
				<span style="margin-left:20px">选项D：</span>
				<input type="text" name="answer" id="chooseD"/>
				<br />
				<br />
				...
				<script type="text/javascript" src="../ueditor/ueditor.config.js"></script>   
				  ...
				  var ue2 = UE.getEditor('title',{toolbars:[["undo","redo",'|',"fontfamily","fontsize", '|',
					...
					<input type="button" name="submit" class="submit" value="提交" id="submitChoose"
		...
		<script type="text/javascript">
			$("#dan").fadeIn(1000);
			$(function(){
				$("#submitChoose").bind("click",function(){
					...
					$.get("addChoose",
					{"chapter":chapter,"type":type,"title":title,"answer":answer,"explain":explain,"chooseA":chooseA,"chooseB":chooseB,"chooseC":chooseC,"chooseD":chooseD},		
					function(data){
						if(data=="true"){
							alert("添加成功");
							window.location.href="add_option.jsp";
						}else{
							alert("添加失败,字太多");
						}
					});
